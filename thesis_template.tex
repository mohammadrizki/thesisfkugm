...
%%%  ---
%%%  Template for Bachelor/Master/Doctoral Thesis at FKKMK UGM
%%%  Created using thesisfkugm.cls
%%%  ---
...
% \documentclass[<bachelor/master/doctoral>,<bahasa/english>]{thesisfkugm}
\documentclass[doctoral,bahasa]{thesisfkugm}
%======================================
% Information Input
%======================================
% Input author's name and ID number
\author{Mohammad Rizki}{<<NIM>>}
% Input the thesis' title
\title{<<Thesis title>>}
% Program and the head of the program
\program{Ilmu Pendidikan Kedokteran dan Kesehatan}{<<Program coordinator>>}{<<NIP>>}
% Name of department head and NIP
\departmenthead{<<Head of the department>>}{<<NIP>>}
\major{<<Major>>}
\yearsubmit{Maret 2024}
\examdate{<<Exam date>>}
...
%{Pendadaran/Tesis/Ringkasan Tesis*}
% *Choose one
